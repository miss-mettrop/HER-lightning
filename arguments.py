...
def get_args():
    ...
    parser.add_argument('--seed', type=int, default=1243, help='random seed')
    ...
    parser.add_argument('--lr-actor', type=float, default=1e-3, help='the learning rate of the actor')
    parser.add_argument('--lr-critic', type=float, default=1e-3, help='the learning rate of the critic')

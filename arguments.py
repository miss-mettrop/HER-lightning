...
def get_args():
    ...
    parser.add_argument('--noise-eps', type=float, default=0.05, help='Noise added to target policy during critic update')
    ...
    parser.add_argument('--action-l2-high', type=float, default=0.02, help='tanh saturation loss for high level')

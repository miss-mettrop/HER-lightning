...
def get_args():
    ...
    parser.add_argument('--random-eps', type=float, default=0.04, help='chance of completely random action')
    parser.add_argument('--noise-clip', type=float, default=0.05, help='Range to clip target policy noise')

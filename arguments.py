...
def get_args():
    ...
    parser.add_argument('--max-epochs', type=int, default=1000, help='the number of epochs to train the agent')
    ...
    parser.add_argument('--noise-eps', type=float, default=0.2, help='Noise added to target policy during critic update')
    parser.add_argument('--random-eps', type=float, default=0.3, help='chance of completely random action')
    parser.add_argument('--noise-clip', type=float, default=0.5, help='Range to clip target policy noise')
    parser.add_argument('--expl-noise', type=float, default=0.2, help='Std of Gaussian exploration noise')
    parser.add_argument('--buffer-size', type=int, default=int(1e6), help='the size of the buffer')
    parser.add_argument('--replay-initial', type=int, default=int(1e3), help='the required initial size of the buffer')
    parser.add_argument('--replay-k', type=int, default=2, help='number of HER transitions for the future method')
    ...
    parser.add_argument('--val-check-interval', type=int, default=500, help='frequency of tests (batches)')
    ...
    parser.add_argument('--action-l2-low', type=float, default=1, help='tanh saturation loss for low level')
    parser.add_argument('--action-l2-high', type=float, default=0.2, help='tanh saturation loss for high level')

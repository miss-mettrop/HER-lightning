...
def get_args():
    ...
    parser.add_argument('--n-batches', type=int, default=40, help='number of optimisation steps per cycle')
    parser.add_argument('--n-cycles', type=int, default=50, help='number of cycles per epoch')
    parser.add_argument('--ep-per-cycle', type=int, default=16, help='number of episodes played each cycle')
    ...
    parser.add_argument('--num-workers', type=int, default=4, help='the number of processes to collect samples')

...
def get_args():
    ...
    parser.add_argument('--action-l2-low', type=float, default=0.5, help='tanh saturation loss for low level')
    parser.add_argument('--action-l2-high', type=float, default=0.01, help='tanh saturation loss for high level')

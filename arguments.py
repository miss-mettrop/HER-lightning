...
def get_args():
    ...
    parser.add_argument('--noise-eps', type=float, default=0.1, help='noise eps')
    parser.add_argument('--random-eps', type=float, default=0.2, help='random eps')
    ...
    parser.add_argument('--action-l2', type=float, default=0.01, help='the tanh saturation fix param')

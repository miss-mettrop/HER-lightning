...
def get_args():
    ...
    parser.add_argument('--noise-eps', type=float, default=0.01, help='Noise added to target policy during critic update')
    parser.add_argument('--random-eps', type=float, default=0.077, help='chance of completely random action')
    parser.add_argument('--noise-clip', type=float, default=0.02, help='Range to clip target policy noise')
    ...
    parser.add_argument('--lr-high', type=float, default=9e-4, help='the learning rate of the actor')
    parser.add_argument('--lr-low', type=float, default=9e-4, help='the learning rate of the critic')
    ...
    parser.add_argument('--action-l2-low', type=float, default=1.3, help='tanh saturation loss for low level')
    parser.add_argument('--action-l2-high', type=float, default=0.1, help='tanh saturation loss for high level')

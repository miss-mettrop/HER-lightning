...
def get_args():
    ...
    parser.add_argument('--expl-noise', type=float, default=0.1, help='Std of Gaussian exploration noise')
    ...
    parser.add_argument('--lr-high', type=float, default=3e-4, help='the learning rate of the actor')
    parser.add_argument('--lr-low', type=float, default=3e-4, help='the learning rate of the critic')
    ...
    parser.add_argument('--action-l2', type=float, default=0.5, help='tanh saturation loss')
